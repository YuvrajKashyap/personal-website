...
export const projects = [
  ...
  },
  {
    ...
    eyebrow: "Live client website",
    summary:
      "Appointment-first client website with a verified Square booking handoff, local SEO, and production guardrails.",
    description:
      "Lucca's Hair is a live client website that gives a working stylist a polished, responsive front door while preserving Square as the booking system of record.",
    ...
    randomizerBucket: "product",
    randomizerWeight: 1,
    tags: ["Client work", "Next.js", "Conversion UX", "Local SEO"],
    stack: [
      "Next.js App Router",
      "TypeScript",
      "Supabase Auth",
    ...
    highlights: [
      "Direct Square handoff preserves the client's live booking workflow",
      "Typed business data keeps service, hours, metadata, and structured data aligned",
      "Fail-closed private routes, regression tests, CI, and a clean dependency audit",
    ],
    problem:
      "A working stylist needed a credible custom website without replacing the booking engine clients already use or publishing uncertain business details as fact.",
    solution:
      "A responsive discovery and trust layer that presents only verified service information, routes every booking action to Square, and keeps private admin surfaces unavailable unless explicitly configured.",
    whatItProves:
      "Client-safe product judgment, conversion-focused frontend craft, careful data boundaries, and production delivery without disrupting a real business workflow.",
    detailSections: [
      {
        eyebrow: "Conversion Boundary",
        title: "Handoff, not reimplementation",
        body: "The custom site owns discovery, trust, and local search presentation. Square remains the source of truth for appointment availability and the final booking transaction.",
      },
      {
        eyebrow: "Data Integrity",
        title: "Verified facts stay centralized",
        body: "A typed business profile drives the service card, operating hours, metadata, and LocalBusiness structured data. Unknown address and policy details are omitted instead of guessed.",
      },
      {
        eyebrow: "Production Guardrails",
        title: "A live client surface with safe failure modes",
        body: "Private routes fail closed when configuration is absent, automated tests protect booking and schema behavior, and CI runs formatting, linting, type checks, tests, builds, and a production-content audit.",
      },
    ],
    timelineLabel: "Live client site",
    updatedAt: "2026-07-17",
    notes:
      "Atmospheric imagery is presented as concept imagery, not as a client haircut gallery. Square remains the booking system of record.",
    links: [
      {
        label: "View live site",
        href: "https://luccas-hair.vercel.app",
        type: "live",
        isPrimary: true,
        status: "verified",
        external: true,
    ...
    media: [
      {
        type: "cover",
        src: "/media/projects/luccas-hair/overview.png",
        alt: "Lucca's Hair homepage showing the appointment-first hero and direct Square booking action",
        theme: "both",
        status: "ready",
        note: "Browser capture of the live appointment website.",
      },
    ],
  },
  {
