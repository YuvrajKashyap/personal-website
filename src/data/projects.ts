...
export const projects = [
  ...
  },
  {
    ...
    summary:
      "Local-first personal intelligence spanning memory, voice, tools, permissions, and continuity across a Windows desktop and phone companion.",
    description:
    ...
    detailSections: [
      {
        ...
        title: "Models reason; policy controls execution",
        body: "Models can propose work, but typed capabilities, exact approvals, cancellation, provenance, audit records, and undo determine what the system may actually do.",
      },
      {
        eyebrow: "Current Boundary",
        title: "Software foundation complete, hardware gate visible",
        body: "The runtime and verification infrastructure are implemented. Daily use remains paused because the current 16 GB host cannot safely keep the minimum capable local model resident beside the full desktop workload.",
      },
    ],
    timelineLabel: "Hardware-gated active build",
    links: [
      {
        label: "GitHub repository",
        href: "https://github.com/YuvrajKashyap/jarvis",
        type: "repo",
        isPrimary: true,
        status: "verified",
        external: true,
  ...
  },
  {
    ...
    slug: "worldstate",
    title: "WorldState",
    shortTitle: "WorldState",
    eyebrow: "Spatial intelligence prototype",
    summary:
    ...
    detailSections: [
      {
        ...
        body: "WorldState models geometry, objects, agents, observations, and changes separately so the interface can show both the current scene and the evidence behind it.",
      },
      {
        eyebrow: "Research Boundary",
        title: "Claims follow reproducible evaluation",
        body: "The project is an active technical prototype. Accuracy and performance claims remain bounded until labeled, reproducible evaluation supports them.",
      },
    ],
    timelineLabel: "Active research prototype",
    links: [
      {
        label: "GitHub repository",
        href: "https://github.com/YuvrajKashyap/worldstate",
        type: "repo",
        isPrimary: true,
        status: "verified",
        external: true,
  ...
  },
  {
    ...
    slug: "answer-map",
    title: "Answer Map",
    shortTitle: "Answer Map",
    eyebrow: "Targeted work sample",
    summary:
      "Realtime conversation intelligence built for Cluely that maps compound questions and verifies coverage against exact transcript evidence.",
    description:
    ...
    detailSections: [
      {
        eyebrow: "Outreach",
        title: "Built before asking for attention",
        body: "Answer Map was built and shipped as a focused work sample for Cluely, so the outreach arrived with a working product, a live demo, and an inspectable repository.",
      },
      {
        eyebrow: "Realtime State",
        title: "Fast cues without stale state",
        body: "Transcript text paints immediately while analysis stays cancellable and finalized coverage updates stay serialized, so late responses cannot overwrite newer state.",
      },
      {
        eyebrow: "Evidence",
        title: "Coverage has to earn its state",
        body: "Partial and covered asks require an exact quote from a finalized candidate turn. Individual guidance and the combined answer remain intact through every coverage update.",
      },
      {
        eyebrow: "Public Boundary",
        title: "A safe demo with honest limits",
        body: "The public build runs a deterministic Guided replay with no credentials, private API calls, or OpenAI spend. Live microphone, model streaming, screen context, and persistence remain local-only paths.",
      },
    ],
    timelineLabel: "Targeted Cluely work sample / live Guided demo",
    ...
    links: [
      {
        label: "Guided demo",
        href: "https://answer-map.vercel.app",
        type: "demo",
        isPrimary: true,
        status: "verified",
        external: true,
      ...
      {
        label: "GitHub repository",
        href: "https://github.com/YuvrajKashyap/answer-map",
        type: "repo",
        status: "verified",
        external: true,
      },
    ...
    media: [
      {
        type: "cover",
        src: "/media/projects/answer-map/portfolio-hero.webp",
        alt: "Answer Map Guided demo with all three interview asks covered and grounded against exact transcript evidence",
        theme: "both",
        status: "ready",
        note: "Real capture from the completed public Guided demo.",
      },
    ],
  },
  {
  ...
  {
    id: "project_frontend_lab",
    slug: "frontend-lab",
    title: "Frontend Lab",
    shortTitle: "Frontend Lab",
    eyebrow: "Open-source interface collection",
    summary:
      "A growing collection of reusable interfaces, interactions, and focused frontend experiments, presented through a live gallery.",
    description:
    ...
    stack: ["React", "TypeScript", "Next.js", "Turborepo", "pnpm"],
    highlights: [
    ...
    detailSections: [
      {
        eyebrow: "Collection",
        title: "Independent builds, one clear system",
        body: "Each experiment stays understandable on its own while shared tooling provides a consistent way to browse, run, validate, and extend the full collection.",
      },
      {
        eyebrow: "Reuse",
        title: "Built to be opened and changed",
        body: "The repository documents a small project contract and publishes the authored work under the MIT License so individual builds can be studied, adapted, and reused.",
      },
    ],
    timelineLabel: "Live and growing",
    links: [
      {
        label: "Browse the live gallery",
        href: "https://gallery-yuvraj-kashyaps-projects.vercel.app",
        type: "live",
        isPrimary: true,
        status: "verified",
        external: true,
      ...
      {
        label: "GitHub repository",
        href: "https://github.com/YuvrajKashyap/frontend",
        type: "repo",
        status: "verified",
        external: true,
      },
